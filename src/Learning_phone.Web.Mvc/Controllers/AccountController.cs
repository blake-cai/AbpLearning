...
using Learning_phone.Web.Models.Account;
using Learning_phone.Web.Views.Shared.Components.TenantChange;

namespace Learning_phone.Web.Controllers
{
    public class AccountController : Learning_phoneControllerBase
    {
